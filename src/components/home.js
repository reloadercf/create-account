...
export const home = () => {
  ...
  startButton.addEventListener('click', () => {
    onNavigate('/post'); // no ejecutas esto
    // ejecutar tu funcion que hace el login
    // usas la promesa para saber si entro o nel
    // como parametro mandas el email, password
  });
